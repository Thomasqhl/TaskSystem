...
{
    public abstract class SimpleTaskTestBase : AbpIntegratedTestBase<SimpleTaskTestModule>
    {
        ...
        protected void UsingDbContext(Action<SimpleTaskDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Func<SimpleTaskDbContext, Task> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected T UsingDbContext<T>(Func<SimpleTaskDbContext, T> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<T> UsingDbContextAsync<T>(Func<SimpleTaskDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<SimpleTaskDbContext> action)
        {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<SimpleTaskDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<SimpleTaskDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<SimpleTaskDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<SimpleTaskDbContext, Task<T>> func)
        {
            T result;
